...
# Unity Catalog paths
UC_CATALOG = os.getenv("UC_CATALOG", "uc")
UC_SCHEMA  = os.getenv("UC_SCHEMA", "wealth")
UC_VOLUME_PATH = os.getenv("UC_VOLUME_PATH", f"/Volumes/{UC_CATALOG}/{UC_SCHEMA}/documents")
